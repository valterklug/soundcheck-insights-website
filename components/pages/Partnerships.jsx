...
export default function Partnerships() {
  ...
  const chips = t.raw('partnerships.chips')
  const problemCards = t.raw('partnerships.problemCards')
  const path1Stats = t.raw('partnerships.path1Stats')
  ...
  const howPath2Steps = t.raw('partnerships.howPath2Steps')
  const formOrgTypeOptions = t.raw('partnerships.formOrgTypeOptions')
  const formInterestOptions = t.raw('partnerships.formInterestOptions')
