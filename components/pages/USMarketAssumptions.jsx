    ...
    <PageWrapper>
      ...
      <section style={{ background: 'var(--navy)', borderBottom: '3px solid var(--orange)', padding: '100px 60px 60px' }} className="article-hero-section">
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          <FadeIn>
            <Link href="/resources" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 11, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--orange)', textDecoration: 'none', display: 'inline-block', marginBottom: 20 }}>
              ← Back to Resources
            </Link>
          ...
          <FadeIn delay={0.1}>
            <div style={{ background: 'rgba(232,71,42,0.06)', border: '1px solid rgba(232,71,42,0.2)', borderLeft: '3px solid var(--orange)', padding: '28px 24px', marginTop: 48 }}>
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                <Link href="/partner" className="btn btn-primary" style={{ fontSize: 12, padding: '10px 18px' }}>
                  Request Platform Access →
                </Link>
                <Link href="/products" className="btn btn-secondary" style={{ fontSize: 12, padding: '10px 18px' }}>
                  See Products
                </Link>
              </div>
            </div>
