...
export default function ConsumerJourneys() {
  ...
  const heroStats = t.raw('consumerJourneys.heroStats')
  const howSteps = t.raw('consumerJourneys.howSteps')
  const outputs = t.raw('consumerJourneys.outputs')
  const faqs = t.raw('consumerJourneys.faqs')
    ...
    <PageWrapper>
      ...
      <section className="page-hero" style={{ borderBottom: '3px solid var(--orange)' }}>
        <div className="page-hero-inner">
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 28 }}>
            <Link href="/contact" className="btn btn-primary">{t('consumerJourneys.ctaButton')}</Link>
          </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <FadeIn>
            <div style={{ background: 'rgba(0,196,212,0.05)', border: '1px solid rgba(0,196,212,0.15)', borderTop: '3px solid var(--teal)', padding: '40px 36px' }}>
              ...
              <Link href="/market-research" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 14, fontWeight: 500, color: 'var(--teal)', textDecoration: 'none', display: 'inline-block', paddingBottom: 4, borderBottom: '1px solid var(--teal)' }}>
      ...
      <section className="cta-strip">
        ...
        <div className="cta-actions" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          <Link href="/contact" className="btn btn-white">{t('consumerJourneys.ctaButton')}</Link>
          <Link href="/products" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>View all products</Link>
        </div>
      </section>
    </PageWrapper>
  )
