...
export default function ScaleAssessment() {
  ...
  const reportSections = t.raw('scaleAssessment.sections')
  const whoCards = t.raw('scaleAssessment.whoCards')
  const deliverables = t.raw('scaleAssessment.deliverables')
  const faqs = t.raw('scaleAssessment.faqs')
    ...
    <PageWrapper>
      ...
      <section className="page-hero" style={{ borderBottom: '3px solid var(--orange)' }}>
        <div className="page-hero-inner">
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 28 }}>
            <Link href="/contact" className="btn btn-primary">{t('scaleAssessment.briefButton')}</Link>
          ...
          <div style={{ display: 'flex', gap: 40, marginTop: 40, flexWrap: 'wrap' }}>
            {t.raw('scaleAssessment.heroStats').map(({ num, label, sub }) => (
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
          ...
          <FadeIn delay={0.1}>
            <div style={{ background: 'rgba(255,165,0,0.03)', border: '1px solid rgba(255,165,0,0.15)', padding: '48px 40px', textAlign: 'center' }}>
              ...
              <Link href="/contact" className="btn btn-primary" style={{ fontSize: 14 }}>{t('scaleAssessment.briefButton')}</Link>
            </div>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="cta-strip">
        ...
        <div className="cta-actions" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          <Link href="/contact" className="btn btn-white">{t('scaleAssessment.ctaButton')}</Link>
          <Link href="/products" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>{t('scaleAssessment.ctaLink')}</Link>
        </div>
      </section>
    </PageWrapper>
  )
