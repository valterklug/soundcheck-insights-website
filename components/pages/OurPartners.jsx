...
export default function OurPartners() {
  ...
  const partners = t.raw('ourPartners.partners')
    ...
    <PageWrapper>
              ...
              <FadeIn key={p.name} delay={i * 0.07}>
                <div style={{
                  ...
                  <div style={{ padding: '28px 36px' }}>
                    ...
                    {p.you ? (
                      <Link href="/contact" className="text-link">{t('ourPartners.startBrief')}</Link>
                    ) : (
      ...
      <section className="cta-strip">
        ...
        <div className="cta-actions">
          <Link href="/contact" className="btn btn-white">{t('ourPartners.ctaButton')}</Link>
        </div>
      </section>
    </PageWrapper>
  )
