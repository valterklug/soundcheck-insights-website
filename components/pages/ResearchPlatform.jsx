...
export default function ResearchPlatform() {
  ...
  const modules = t.raw('researchPlatform.modules')
  const pricingRows = t.raw('researchPlatform.pricingRows')
  const pricingColumns = t.raw('researchPlatform.pricingColumns')
    ...
    <PageWrapper>
      ...
      <section className="page-hero" style={{ borderBottom: '3px solid var(--teal)' }}>
        <div className="page-hero-inner">
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <Link href="/contact" className="btn btn-primary">{t('researchPlatform.ctaButton')}</Link>
              ...
              <FadeIn key={module.num} delay={i * 0.1}>
                <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', padding: '40px 36px', borderTop: i === 0 ? '3px solid var(--teal)' : 'none', borderBottom: i < modules.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 24, paddingLeft: 74, marginBottom: 20 }}>
                    ...
                    <div>
                      <div style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 10, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: 8 }}>Scope</div>
                  ...
                  <div style={{ paddingLeft: 74 }}>
                    <Link href={module.link} style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: 'var(--teal)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', transition: 'opacity 0.2s' }}>
                      {module.linkLabel}
                    </Link>
                  </div>
                </div>
          ...
          <StaggerContainer style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }} className="who-grid">
            ...
            <StaggerItem>
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderTop: '3px solid var(--teal)', padding: '40px 36px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <Link href="/partner" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: 'var(--teal)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
      ...
      <section className="cta-strip">
        ...
        <div className="cta-actions" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          <Link href="/contact" className="btn btn-white">{t('researchPlatform.ctaButton')}</Link>
          <Link href="/products" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>See All Products →</Link>
        </div>
      </section>
    </PageWrapper>
  )
