          ...
          <FadeIn delay={0.15}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <div style={{ background: 'rgba(6,15,30,0.03)', padding: '18px 20px', border: '1px solid rgba(6,15,30,0.07)', marginTop: 0 }}>
                ...
                <Link href="/our-partners" style={{ fontFamily: 'IBM Plex Sans, sans-serif', fontSize: 12, fontWeight: 500, color: 'var(--orange)', textDecoration: 'none', borderBottom: '1px solid rgba(232,71,42,0.3)', paddingBottom: 1, display: 'inline-block' }}>
