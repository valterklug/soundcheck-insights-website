...
export const seoConfig = {
  '/': {
    ...
    description:
      'Decision-grade market intelligence for operators - agencies, consultancies, and fractional executives delivering productized research, validation, and strategic insights to international brands entering and scaling in the US.',
    image: '/og/og-home.png',
    keywords:
      'market intelligence, AI research, agency platform, white-label research, market analysis, competitive intelligence, operator platform, fractional executive',
  },
  '/products': {
  ...
  '/how-it-works': {
    title: 'How It Works',
    description:
      'Four steps from brief to delivery. You run the client intake, the AI generates the research, you validate with your expertise, and you deliver under your brand.',
    image: '/og/og-how-it-works.png',
    keywords:
      'how soundcheck works, AI research process, market intelligence workflow, agency research platform',
  },
  '/for-agencies': {
